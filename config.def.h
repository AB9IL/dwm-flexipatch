...
#if BAR_PANGO_PATCH
static const char font[]                 = "Arimo Nerd Font 11";
#else
...
static char normfgcolor[]                = "#dddde0";
static char normbgcolor[]                = "#000000";
static char normbordercolor[]            = "#444444";
static char normfloatcolor[]             = "#db8fd9";

static char selfgcolor[]                 = "#dddde0";
static char selbgcolor[]                 = "#1d388a";
static char selbordercolor[]             = "#3259ce";
static char selfloatcolor[]              = "#3259ce";

static char titlenormfgcolor[]           = "#dddde0";
static char titlenormbgcolor[]           = "#000000";
static char titlenormbordercolor[]       = "#444444";
static char titlenormfloatcolor[]        = "#db8fd9";

static char titleselfgcolor[]            = "#dddde0";
static char titleselbgcolor[]            = "#000000";
static char titleselbordercolor[]        = "#1d388a";
static char titleselfloatcolor[]         = "#1d388a";

static char tagsnormfgcolor[]            = "#dddde0";
static char tagsnormbgcolor[]            = "#000000";
static char tagsnormbordercolor[]        = "#444444";
static char tagsnormfloatcolor[]         = "#db8fd9";

static char tagsselfgcolor[]             = "#dddde0";
static char tagsselbgcolor[]             = "#3259ce";
static char tagsselbordercolor[]         = "#3259ce";
static char tagsselfloatcolor[]          = "#3259ce";

static char hidnormfgcolor[]             = "#3259ce";
static char hidselfgcolor[]              = "#227799";
static char hidnormbgcolor[]             = "#000000";
static char hidselbgcolor[]              = "#000000";

static char urgfgcolor[]                 = "#dddde0";
...
static const Rule rules[] = {
	...
	RULE(.wintype = WTYPE "SPLASH", .isfloating = 1)
 	RULE(.instance = "zenity", .isfloating = 1 )
 	RULE(.instance = "yad", .isfloating = 1 )
 	RULE(.instance = "Terminal", .isfloating = 1 )
 	RULE(.instance = "org.wezfurlong.wezterm", .isfloating = 1 )
 	RULE(.instance = "pavucontrol", .isfloating = 1 )
 	RULE(.instance = "Pavucontrol", .isfloating = 1 )
 	RULE(.instance = "blueman-manager", .isfloating = 1 )
 	RULE(.instance = "Blueman-manager", .isfloating = 1 )
 	RULE(.instance = "caja", .isfloating = 1)
 	RULE(.instance = "Caja", .isfloating = 1)
 	RULE(.instance = "thunar", .isfloating = 1)
 	RULE(.instance = "Thunar", .isfloating = 1)
 	RULE(.instance = "firefox", .isfloating = 0)
 	RULE(.instance = "Firefox", .isfloating = 0)
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_s,          togglesticky,           {0} },
 	...
 	{ MODKEY,                       XK_F1,         scratchpad_show,        {0} },
 	{ MODKEY|ShiftMask,             XK_F1,         scratchpad_hide,        {0} },
 	{ ControlMask|ShiftMask,        XK_F1,         scratchpad_remove,      {0} },
